...
func initializeApplication(buildInfo handler.BuildInfo) (*Application, error) {
	...
	groupHandler := admin.NewGroupHandlerWithConfig(adminService, dashboardService, groupCapacityService, configConfig, agentModelCatalogService)
	...
	desktopUpdateService := service.NewDesktopUpdateService(db, settingRepository, secretEncryptor, backupObjectStoreFactory, configConfig)
	...
	videoHandler := handler.ProvideVideoHandler(videoService, agentHandler)
	...
	updateHTTPServer := server.ProvideUpdateHTTPServer(handlers)
