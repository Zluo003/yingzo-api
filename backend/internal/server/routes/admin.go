...
func registerDesktopUpdateRoutes(admin *gin.RouterGroup, h *handler.Handlers) {
	updates := admin.Group("/desktop-updates")
	{
		...
		updates.GET("/uploads", h.Admin.DesktopUpdate.ListUploads)
		updates.POST("/uploads", h.Admin.DesktopUpdate.CreateUpload)
		updates.GET("/uploads/:id", h.Admin.DesktopUpdate.UploadStatus)
		updates.POST("/uploads/:id/chunks/:artifact", h.Admin.DesktopUpdate.AppendUploadChunk)
		updates.POST("/uploads/:id/complete", h.Admin.DesktopUpdate.CompleteUpload)
		updates.POST("/uploads/:id/retry", h.Admin.DesktopUpdate.RetryUpload)
		updates.DELETE("/uploads/:id", h.Admin.DesktopUpdate.DeleteUpload)
