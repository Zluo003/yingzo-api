export default {
    ...
    dashboard: {
      ...
      onlineGeography: 'Online user locations',
      onlineGeographyHint: 'Estimated from the latest heartbeat IP; users are counted once.',
      geoLookup: 'Look up locations',
      geoLoading: 'Looking up…',
      geoLookupHint: 'Look up IP locations to see where online users are.',
      geoLookupFailed: 'Some IP lookups failed. Please try again later.',
      geoUnknown: 'Unknown location',
      noOnlineUsers: 'No users are online right now.',
