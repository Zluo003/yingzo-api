export default {
    ...
    dashboard: {
      ...
      onlineUsers: '在线用户',
      onlineGeography: '在线用户地域分布',
      onlineGeographyHint: '按最近心跳的来源 IP 估算，人数按用户去重。',
      geoLookup: '查询归属地',
      geoLoading: '查询中…',
      geoLookupHint: '点击查询归属地，查看当前在线用户的地域分布。',
      geoLookupFailed: '部分 IP 归属地查询失败，请稍后重试。',
      geoUnknown: '未知地区',
      noOnlineUsers: '当前没有在线用户。',
      totalUsers: '用户总数',
      activeUsers: '活跃用户',
      accounts: '账号',
      totalAccounts: '账号总数',
