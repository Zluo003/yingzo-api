...
const BADGE: Record<Platform, string> = {
  ...
  video: 'bg-cyan-500/10 text-cyan-600 border-cyan-500/30 dark:text-cyan-400',
...
const BADGE_LIGHT: Record<Platform, string> = {
  ...
  video: 'bg-cyan-500/10 text-cyan-600 dark:bg-cyan-500/10 dark:text-cyan-300',
...
const ICON: Record<Platform, string> = {
  ...
  video: 'text-cyan-500 dark:text-cyan-400',
