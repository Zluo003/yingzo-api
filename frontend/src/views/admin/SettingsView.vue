  ...
  <AppLayout>
    <div class="mx-auto max-w-6xl space-y-6">
      ...
      <form v-else @submit.prevent="saveSettings" class="space-y-6" novalidate>
        ...
        <!-- Tab: Asset Storage -->
        <div v-show="activeTab === 'assetStorage'">
          <AssetStorageSettings />
        </div>

        <!-- Save Button -->
        <div
          v-show="activeTab !== 'backup' && activeTab !== 'assetStorage'"
...
import AssetStorageSettings from "@/views/admin/AssetStorageView.vue";
...
const paymentGuideHref = computed(() =>
  locale.value.startsWith("zh")
    ? "https://github.com/Zluo003/yingzo-api/blob/main/docs/PAYMENT_CN.md"
    : "https://github.com/Zluo003/yingzo-api/blob/main/docs/PAYMENT.md",
);

const paymentMethodsHref = computed(() =>
  locale.value.startsWith("zh")
    ? "https://github.com/Zluo003/yingzo-api/blob/main/docs/PAYMENT_CN.md#支持的支付方式"
    : "https://github.com/Zluo003/yingzo-api/blob/main/docs/PAYMENT.md#supported-payment-methods",
);
...
const settingsTabs = [
  ...
  { key: "assetStorage" as SettingsTab, icon: "cube" as const },
];
